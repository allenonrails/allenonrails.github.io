...
Gem::Specification.new do |s|
  ...
  s.metadata = { "bug_tracker_uri" => "https://github.com/jeremyevans/roda/issues", "changelog_uri" => "http://roda.jeremyevans.net/rdoc/files/CHANGELOG.html", "documentation_uri" => "http://roda.jeremyevans.net/documentation.html", "mailing_list_uri" => "https://github.com/jeremyevans/roda/discussions", "source_code_uri" => "https://github.com/jeremyevans/roda" } if s.respond_to? :metadata=
